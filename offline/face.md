...
|	appid	|	appid	|	32	|	O	|	商户号绑定的公众号/小程序appid，如：appidwx740a066b0a94fa6 	  |
|	mchId	|	微信商户号	|	32	|	O	|	微信商户号，如：1502469151	  |
|	subMchId	|	微信子商户号(服务商模式)	|	32	|	O	|	微信子商户号(服务商模式)	  |
|	authinfo	|	sdk调用凭证	|	4096	|	O	|	sdk调用凭证	|
|	expiresIn	|	有效期	|	32	|	O	|	authinfo的有效时间, 单位秒	|
|	signature	|	签名	|	256	|	M	|	参见签名机制	|
